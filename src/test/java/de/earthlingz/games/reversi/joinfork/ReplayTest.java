...
public class ReplayTest {
   ...
   {
      final ConsoleAppender consoleAppender = new ConsoleAppender(new PatternLayout(PatternLayout.DEFAULT_CONVERSION_PATTERN));
      consoleAppender.setThreshold(Level.INFO);
      Logger.getRootLogger().addAppender(consoleAppender);
   }
    
   @Test public void wipeOut()
   {
       //WOC 2010, round 1
      //TAKIZAWA Masaki 	64
      //TERKELSEN Signe 	0     
   ...
   @Test public void draw()
   {
    ...
    private List<String> split(String game) {
        ArrayList<String> moves = new ArrayList<String>(60);
        while(game.length() > 0)
        {
